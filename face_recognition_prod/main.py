...
def run():
    ...
    path ='./encodings_face_videos_half/rec-aae24d0b-11c8-432e-8122-126e4ea60611-RUzrbFxkHM-Qm34q3yjV8r2KLKI-1584629640425-video-face.webm.pkl'#path of the test encodings
    face_authenticator = FaceAuthenticator(path)

    v_path = './rec-920e9140-85df-4c9f-976a-cb1dbf965631-7avfemevEJ-KugjJX1pMJjZl6hH-1579721759218-video-face.webm'#same person
    v2_path = './rec-b8b6dd4f-d57d-45ad-b0aa-19cd47baa410-DShHqPGa9M-wH081WkwGS0T7bwc-1580309908256-video-face.webm'#different person

    video_capture = cv2.VideoCapture(v_path)#video path
